...
const RocketAlert = ({ setRocketNumber, handleRocketNumber, setOpenPopup }) => {
    ...
    const handleSendPassword = () => {
        if (password !== constant_password) {
            ...
            handleRocketNumber('639cbb49ed88a659e6f56749')
            setRocketNumber('')
            setOpenPopup(false);
        }
    }
                ...
                <div className="w-full lg:w-6/12 px-4">
                    <div className="relative w-full mb-3">
                        <button
                            ...
                            className="bg-[#37BC96] px-10 text-white active:bg-lightBlue-600 font-bold uppercase text-xs py-3 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
                            type="button"
                        >
                            Ok
                        </button>
