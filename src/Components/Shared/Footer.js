...
import shape from '../../Asset/curveAsymmetrical.svg'
        ...
        <div className='mt-5'>
            ...
            <footer className="bg-[#0F1729]">
                ...
                <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-400 uppercase">SS Shop</h2>
                    ...
                    <div>
                        ...
                        <ul className="text-gray-300 ">
                            ...
                            <li className="mb-4">
                                <Link to="https://www.facebook.com/sourav.radha.483" className="hover:underline">Facebook
                                </Link>
                            </li>
                            <li className="mb-4">
                                <Link to="https://www.facebook.com/sourav.radha.483" className="hover:underline">Contact Us</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="py-6 px-4 bg-black md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center">© {new Date().getFullYear()} <Link to="https://www.facebook.com/sourav.radha.483">SS Shop</Link>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                        <a href="https://www.facebook.com/sourav.radha.483" className="text-gray-400 hover:text-white">
